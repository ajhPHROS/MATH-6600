...
\fancyhead[RO,R]{\textbf{Due} Friday 9/25/26}
\fancyfoot[LO,L]{}
...
\noindent
\textbf{Bonus (Optional).} On homework 1, you may have noticed that the Fourier coefficients of some of the nonsmooth functions decayed at a faster rate than the upper bounds you derived. Can you derive a sharper upper bound for the decay rate of Fourier coefficients of a function whose $n$th derivative is piecewise continuous with a discontinuity at the origin? 
