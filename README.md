...
**Grading:** 25% homework (due every 1-2 weeks), 25% mid-term (Oct 30), 25% project (Dec 4), 25% oral exam (Dec 7-11). Problem sets must be submitted to Gradescope before the deadline on the due date. Regrade requests can be made on Gradescope within one week of return.
...
- [Homework 1](hw/hw01.pdf) is due by 6pm on Wednesday, September 9. See solutions [here](https://piazza.com/class/mtbqhy9rr432i1/post/17).
- [Homework 2](hw/hw02.pdf) is due by 6pm on Friday, September 25.
